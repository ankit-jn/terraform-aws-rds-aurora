...
Refer [Configuration Examples](https://github.com/ankit-jn/terraform-aws-examples/tree/main/aws-rds-aurora) for effectively utilizing this module.
...
| <a name="cluster_reader_endpoint"></a> [cluster_reader_endpoint](#output\_cluster\_reader\_endpoint) | `string` | RDS Aurora Cluster Read only Endpint; automatically load-balanced across replicas |
...
Module is maintained by [Ankit Jain](https://github.com/ankit-jn) with help from [these professional](https://github.com/ankit-jn/terraform-aws-rds-aurora/graphs/contributors).
